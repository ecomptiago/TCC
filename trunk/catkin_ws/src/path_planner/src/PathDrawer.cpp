...
//Constructors
PathDrawer::PathDrawer(int argc, char **argv, int cellArea, int mapWidth, int mapHeight,
...
bool PathDrawer::addObjectToOccupancyMap(int32_t childHandle) {
	if (childHandle != responseError) {
		common::simRosGetObjectPose simRosGetObjectPose;
...
bool PathDrawer::getMinimumXYObjectCoordinate(int32_t objecthandle,
...
bool PathDrawer::getObjectWidthHeight(int32_t objectHandle,
	path_planner::ObjectInfo &objectInfo) {
...
void PathDrawer::callGetFloatParameterService(int32_t objectHandle,
	int32_t parameterID,
	path_planner::simRosGetObjectFloatParameter &simRosGetObjectFloatParameter) {
...
int main(int argc, char **argv) {
	PathDrawer pathPlanner(argc,argv,1,10,10,10,1);
	try{
